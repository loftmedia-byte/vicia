...
export function OpenSourceSection() {
  const items = [
    ...
    },
    {
      ...
      description: 'Vicia transparency meets enterprise security. Deploy behind your firewall with full control over models, data, and integrations.',
      showFeatures: true,
    },
  ];
        ...
        <div className="max-w-6xl mx-auto border-l border-r border-border">
          ...
          <SectionHeader>
            <h2 className="text-3xl md:text-4xl font-medium tracking-tighter text-center text-balance">
              100% On Premises for Enterprise Needs
            </h2>
