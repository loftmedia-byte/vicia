...
async def run_agent_background(
    ...
    async def check_for_stop_signal():
        ...
        try:
            ...
            logger.error(f"Error in stop signal checker for {agent_run_id}: {e}")
    ...
    try:
        ...
        try:
            ...
            logger.error(f"Redis failed to subscribe to control channels: {e}")
            raise e
...
async def update_agent_run_status(
    ...
    try:
        ...
        logger.error(f"Unexpected error updating agent run status for {agent_run_id}: {str(e)}")
        return False
